...
class Countries {
    ...
    fun randomImageID(): List<Any> {
        val randomKey = countriesMap.keys.toList().random().lowercase()
        val resIdName = randomKey.replace(" ", "_")
